...
#
# This script sets up sensible macOS defaults for a developer-focused environment.
# Many of these settings require a restart to take effect.
...
# Enable TouchID for sudo (if available)
if [[ -f "/usr/bin/pam_tid.so" ]]; then
